...
public class RatingDialogFragment extends DialogFragment {
    ...
    @BindView(R.id.appointment_form_rating)
    MaterialRatingBar mRatingBar;

    @BindView(R.id.appointment_form_text)
    ...
    @OnClick(R.id.appointment_form_button)
    public void onSubmitClicked(View view) {
        Rating rating = new Rating(
                FirebaseAuth.getInstance().getCurrentUser(),
                mRatingBar.getRating(), mRatingText.getText().toString());
    ...
    @OnClick(R.id.appointment_form_cancel)
